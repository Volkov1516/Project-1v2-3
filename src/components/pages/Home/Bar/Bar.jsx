...
export const Bar = () => {
  ...
  return (
    <div className={css.container}>
      ...
      <Modal
        loading={loadingCreateFolderModal}
      ...
      <Settings open={openSettingsModal} setOpen={setOpenSettingsModal} />
    </div >
  );
};
