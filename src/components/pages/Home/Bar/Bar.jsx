    ...
    <div className={css.container}>
      <div className={css.start}>
        ...
        <Tooltip position="right" text="Add Folder">
          <IconButton onClick={() => handlePathname('addFolder')} path="M120-200v-560h263.846l80 80H840v480H120Zm40-40h640v-400H447.769l-80-80H160v480Zm0 0v-480 480Z" />
        </Tooltip>
      </div>
