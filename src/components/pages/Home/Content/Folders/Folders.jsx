  ...
  return (
    <div id="folders" className={css.container}>
      {folders?.map((i, index) => (
        ...
        >
          <div data-index={index} data-id={i.id} data-type="folder" className={css.start}>
            <svg data-index={index} data-id={i.id} data-type="folder" className={css.svg} viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
              <path data-index={index} data-id={i.id} data-type="folder" d="M853.333333 256H469.333333l-85.333333-85.333333H170.666667c-46.933333 0-85.333333 38.4-85.333334 85.333333v170.666667h853.333334v-85.333334c0-46.933333-38.4-85.333333-85.333334-85.333333z" fill="#FFA000" /><path d="M853.333333 256H170.666667c-46.933333 0-85.333333 38.4-85.333334 85.333333v426.666667c0 46.933333 38.4 85.333333 85.333334 85.333333h682.666666c46.933333 0 85.333333-38.4 85.333334-85.333333V341.333333c0-46.933333-38.4-85.333333-85.333334-85.333333z" fill="#FFCA28" />
            </svg>
            {i.name}
          </div>
          <span data-index={index} data-id={i.id} data-type="folder" className={css.settings}>
