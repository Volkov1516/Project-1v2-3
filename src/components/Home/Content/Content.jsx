  ...
  return (
    <div className={css.container} onScroll={onMouseUp}>
      ...
      <div className={css.testTaskWithCircle}>
        ...
        <span>
          Define the new design system for the project. Define the new design system for the project. Define the new design system for the project.
        </span>
      </div>
